...
public class ErpNoRedisDAO {
    ...
    /**
     * 生产订单 {@link cn.iocoder.yudao.module.erp.dal.dataobject.purchase.ErpPurchaseOrderDO}
     */
    public static final String PRODUCTION_ORDER_NO_PREFIX = "SCDD";


    /**
     * 原料配比单号 {@link cn.iocoder.yudao.module.erp.dal.dataobject.purchase.ErpPurchaseOrderDO}
     */
    public static final String RAW_NO_PREFIX = "YLPB";

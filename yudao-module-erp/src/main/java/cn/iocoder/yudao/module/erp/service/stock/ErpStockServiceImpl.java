...
public class ErpStockServiceImpl implements ErpStockService {
    ...
    @Override
    public BigDecimal getStockCountByWarehouseId(Long productId, Long warehouseId) {
        BigDecimal count = stockMapper.getStockCountByWarehouseId(productId,warehouseId);
        return count != null ? count : BigDecimal.ZERO;
    }

...
public class ErpStockRespVO {
    ...
    @Schema(description = "冻结库存", requiredMode = Schema.RequiredMode.REQUIRED, example = "21935")
    @ExcelProperty("冻结库存")
    ...
    @Schema(description = "产品规格", requiredMode = Schema.RequiredMode.REQUIRED, example = "1*1*1")
    @ExcelProperty("产品规格")

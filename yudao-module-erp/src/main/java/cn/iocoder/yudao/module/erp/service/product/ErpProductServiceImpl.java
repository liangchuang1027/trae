...
public class ErpProductServiceImpl implements ErpProductService {
    ...
    public PageResult<ErpProductRespVO> getProductVOPage(ErpProductPageReqVO pageReqVO) {
        ...
        if (pageReqVO.getCategoryId() != null) {
            longs = erpProductCategoryMapper.selectByParentIdOrId(pageReqVO.getCategoryId());
        }


        PageResult<ErpProductDO> pageResult = productMapper.selectPage(pageReqVO, longs);
    ...
    @Override
    public List<ErpProductRespVO> getProductCommodity() {



        return productMapper.selectCommodity();
    }

    @Override
    public List<ErpProductRespVO> getProductYuan() {
        return productMapper.getProductYuan();

...
//    ErrorCode USER_REGISTER_DISABLED = new ErrorCode(1_002_003_011, "注册功能已关闭");
    ...
    ErrorCode PRODUCT_NOT_EXIST = new ErrorCode(27_1, "原料不存在");

    ErrorCode WEIGHING_DETAILS_IMPORT_STOCK_NOT_ENOUGH = new ErrorCode(27_0_0_33, "部分原料库存不足，请核对原料库存。");

    ErrorCode WEIGHING_DETAILS_IMPORT_LIST_IS_EMPTY = new ErrorCode(27_0_0_04, "导入过磅信息数据不能为空！");
       ErrorCode WEIGHING_DETAILS_EXISTS = new ErrorCode(27_0_0_05, "过磅信息已存在");
       ErrorCode RUCAN_ERROR = new ErrorCode(27_0_0_06, "上传数据表格格式错误");




    // ========== 红正建材审核记录 TODO 补充编号 ==========
    ErrorCode HZ_REVIEW_RECORD_NOT_EXISTS = new ErrorCode(132123, "红正建材审核记录不存在");
    ErrorCode RU_CAN_ERROR = new ErrorCode(10521, "入参不可为空");


    ErrorCode HZ_PRODUCT_WEIGHING_DETAILS_NOT_EXISTS = new ErrorCode(12121, "成品出库过磅明细表不存在");


    // ========== 红正建材项目 TODO 补充编号 ==========
    ErrorCode ORDER_STATUS_ERROR = new ErrorCode(10500, "订单状态不允许此操作");

    // ========== 红正客户 TODO 补充编号 ==========
    ErrorCode GUEST_NOT_EXISTS = new ErrorCode(11283, "红正客户不存在");

    // ========== 红正建材项目 TODO 补充编号 ==========
    ErrorCode HZ_PROJECT_NOT_EXISTS = new ErrorCode(11111, "红正建材项目不存在");
    // ========== 在库形态转换 TODO 补充编号 ==========
    ErrorCode STOCK_CONVERSION_NOT_EXISTS = new ErrorCode(12121222, "在库形态转换不存在");
    // ========== 红正建材订单表 TODO 补充编号 ==========
    ErrorCode HZ_ORDER_NOT_EXISTS = new ErrorCode(22222, "订单不存在");
    // ========== 配比模版 TODO 补充编号 ==========
    ErrorCode HZ_MATCHING_FORM_NOT_EXISTS = new ErrorCode(33333, "配比模版不存在");
    ErrorCode HZ_MATCHING_FORM_RAW_NOT_EXISTS = new ErrorCode(44444, "配比模版原料不存在");
    // ========== 配比模版原料 TODO 补充编号 ==========

// ========== 配比实例 TODO 补充编号 ==========
    ErrorCode HZ_MATCHING_EXAMPLE_NOT_EXISTS = new ErrorCode(5555, "配比实例不存在");

    // ========== 配比原料实例 TODO 补充编号 ==========
    ErrorCode HZ_MATCHING_EXAMPLE_RAW_NOT_EXISTS = new ErrorCode(6666, "配比原料实例不存在");

...
public class ProductSaveReqVO {
    ...
    @Schema(description = "产品属性", requiredMode = Schema.RequiredMode.REQUIRED, example = "2")
    @NotNull(message = "产品属性不能为空")
    private Integer property;

    @Schema(description = "是否商品", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    @NotNull(message = "是否商品不能为空")
    private Integer isCommodity;

    @Schema(description = "是否可库存 1可库存 2不可库存", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    @NotNull(message = "是否可库存不能为空")
